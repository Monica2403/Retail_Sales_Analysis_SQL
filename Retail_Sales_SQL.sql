...
--	Q.7 Write SQL query to calculate the average sale for each month. Find out best best-selling month in each year
...
--Q.9 Write SQL query to Find the nuber of unique customers who purchased items from each category.
...
--Q.10 Write a SQL query to create each shift and number of the orders (Example Morning <= 12, Afternoon between 12 & 17 , Evening > 17)
WITH hourly_sale AS (
    SELECT *,
        CASE
